...
label act1_1_shot_3:
    ...
    diary "{=down_text}ฝากถึงทุกท่าน มิวแทนต์⬜⬜⬜เป็นอันตราย{/down_text}"
...
label act1_1_shot_4_q1_c2:
    ...
    show tsuru maid_smile2 at leftpostsuru
    with dissolve
    tsuru "อะฮุฮิฮุฮิ คุโมกุ ซึรุรุ เมดก้อนเมฆตัวน้อยยยที่น่ารักจากร้าน “ฮันนี่รีเวิร์ส” พร้อมที่จะมาให้บริการพี่ๆแล้วค่าาา"
...
label act1_1_shot_7:
    ...
    pov "อ๋อนี่เป็นห้องของญาติฉันเองแหละ แต่ว่าเขาต้องไปดูแลกิจการอีกสาขาที่ต่างจังหวัด ก็เลยไม่ค่อยได้กลับมาใช้ห้องนี้แล้วน่ะ"
